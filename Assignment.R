...
=========================================================================
AB HIER LÖSCHEN UND NICHT IN LÖSUNGS FILE
=========================================================================
...
Dataset misses variables necessary for prediction.

names(predData)
nameBoth <- nameBoth[-13]
predData <- predData[nameBoth]
setdiff(names(mainData),names(predData))

#predData$classe <- as.factor()

predData$classe
str(predData)
str(mainData)

predictedTest <- predict(modelRF,newdata=predData)
